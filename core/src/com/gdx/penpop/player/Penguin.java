...
public class Penguin extends SpriteInfo {
	private float x, y, size;
	private Body penguinBody, leftArmbody, rightArmBody;
	private World world;
	private Assets assets;

	public Penguin(World world, float x, float y, float size, Assets assets) {
		this.world = world;
		this.x = x;
		this.y = y;
		this.size = size;
